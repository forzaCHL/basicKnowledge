...
//    UIAlertController *alert = [[UIAlertController alloc]initWithTitle:@"category" message:@"UIAlertController" style:UIAlertControllerStyleAlert can];

    UIAlertController *alert = [[UIAlertController alloc]initWithTitle:@"category" message:@"UIAlertController" style:UIAlertControllerStyleAlert cancleAction:^{
        NSLog(@"1111111");
    } sureAction:cancelAction];
